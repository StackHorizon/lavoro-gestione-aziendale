import React, {useState, useEffect, useRef} from 'react';
    ...
    const Lavori = () => {
        ...
        const handleNavigateToDashboard = () => {
            // Animazione di uscita prima di navigare alla dashboard
            if (headerRef.current && cardGridRef.current && searchBarRef.current) {
                const tl = gsap.timeline({
        ...
        const handleLogout = async () => {
            // Animazione del pulsante logout
            const logoutButton = document.querySelector('button:has(.lucide-log-out)');
            if (logoutButton) {
                gsap.fromTo(
                    logoutButton,
                    {scale: 1},
            ...
            // Animazione per tutta la pagina durante il logout
                    ...
                    if (cardToRemove) {
                        ...
                        gsap.timeline()
                            ...
                            .to(cardToRemove, {
                                ...
                                margin: window.getComputedStyle(cardToRemove).margin,
                                duration: 0
                            })
                            .to(cardToRemove, {
                                opacity: 0,
